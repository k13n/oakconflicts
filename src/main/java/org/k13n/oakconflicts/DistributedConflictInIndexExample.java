...
public class DistributedConflictInIndexExample {
    private static final Logger logger = LoggerFactory.getLogger(DistributedConflictInIndexExample.class);
    private static final int ASYNC_DELAY_MS = 10000;
    private static final String PROPERTY = "sessionId";
    private static final String DB_NAME = "test4";

    public static void main(String[] args) throws UnknownHostException {
        new DistributedConflictInIndexExample().execute();
    }
